...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { seats_available: @table.seats_available, table_no: @table.table_no } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { seats_available: @table.seats_available, table_no: @table.table_no } }
